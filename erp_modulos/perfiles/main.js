                    ...
                    success: function (data) {
                        ...
                        if (json.status == 0) {
                            ...
                            Swal.fire({
                                icon: "error",
                                title: "Error...",
                                text: "Selecciona un modulo a consultar para poder insertar datos en el.",
                            })
                        } else if (json.status == 4) {
                            Swal.fire({
                                icon: "error",
                                title: "Error...",
                                text: "Selecciona un modulo a consultar para poder editar datos en el.",
                            })
                        } else if (json.status == 5) {
                            Swal.fire({
                                icon: "error",
                                title: "Error...",
                                text: "Selecciona un modulo a consultar para poder eliminar datos en el.",
                            })
                        } else if (json.status == 6) {
                            Swal.fire({
                                icon: "error",
                                title: "Error...",
                                text: "No puedes insertar en un modulo donde no puedas consultarlo.",
                            })
                            ...
                            Swal.fire({
                                icon: "error",
                                title: "Error...",
                                text: "No puedes eliminar en un modulo donde no puedas consultarlo.",
                            })
